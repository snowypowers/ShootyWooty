...
//                    moveHandler.setShot(false);
                    moveHandler.setBulletPosition(s);
                    while (!shot){
                        shot = moveHandler.shootBullet(delta);
                        Gdx.app.log("GameWorldShot", moveHandler.getShot()+"");
//                        moveHandler.setShot(true);
 					}
                    shot = false;
                    moveHandler.resetBullet();
